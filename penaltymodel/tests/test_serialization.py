...
from penaltymodel.serialization import _serialize_linear_biases
...
class TestGraphSerialization(unittest.TestCase):
    def test_graph_encode_decode(self):
        ...
        for G in graphs:
            ...
            num_nodes, num_edges, edges_str = pm.serialize_graph(nodelist, edgelist)
            H_nodelist, H_edgelist = pm.decode_graph(num_nodes, num_edges, edges_str)
...
class TestConfigurationsSerialization(unittest.TestCase):
    def test_configurations_encode_decode(self):
        ...
        self.assertEqual(configurations,
                         pm.decode_configurations(*pm.serialize_configurations(configurations)))
