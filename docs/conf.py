...
# built documents.
#
import penaltymodel_cache.package_info as pckinfo
...
modindex_common_prefix = ['penaltymodel_cache.']

doctest_global_setup = "import penaltymodel_cache as pmc"
...
htmlhelp_basename = 'penaltymodel_cache'
...
latex_documents = [
    (master_doc, 'penaltymodel_cache.tex', u'D-Wave Penalty Model Cache Documentation',
...
man_pages = [
    (master_doc, 'penaltymodel_cache', u'D-Wave Penalty Model Cache Documentation',
     [author], 1)
]
